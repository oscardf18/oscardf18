...
namespace ExamenFinalProgra3.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,NombreProducto,IdProveedor,IdCategoria,PrecioCosto,PrecioVenta,NivelNuevoPedido,Suspendido")] Productos productos)
        {
            ...
            ViewData["IdProveedor"] = new SelectList(_context.Proveedores, "IdProveedor", "IdProveedor", productos.IdProveedor);
            return View(productos);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,NombreProducto,IdProveedor,IdCategoria,PrecioCosto,PrecioVenta,NivelNuevoPedido,Suspendido")] Productos productos)
        {
